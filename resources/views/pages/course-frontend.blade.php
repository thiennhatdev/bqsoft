...
@section('head')
    ...
    <meta property="og:title" content="Khoá học lập trình Frontend" />
    ...
    <meta property="og:site_name" content="Khoá học lập trình Frontend" />
            ...
            <div class="col-12">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item text-white active" aria-current="page">Khoá học Frontend</li>
                    </ol>
                </nav>
            </div>
          </div>
                    ...
                    <div class='course-body'>
                        ...
                        <div class='course-body__content'>
                            ...
                            <div>
                                <ul>
                                    <li>
                                        <label class='course-chapter'>Html</label>
                                        <p class='course-chapter-content'>- Nắm rõ các thẻ trong HTML và cách dùng</p>
                                    </li>
                                    <li>
                                        <label class='course-chapter'>Css</label>
                                        <p class='course-chapter-content'>- Hiểu biết hầu hết về style cho các thẻ HTML</p>
                                        <p class='course-chapter-content'>- Học về Scss (hoặc Sass)</p>
                                        <p class='course-chapter-content'>- Responsive</p>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        <label class='course-chapter'>Reactjs</label>
                                        <p class='course-chapter-content'>- Hiểu rõ về thư viện Reactjs</p>
                        ...
                        <div class='course-body__result'>
                            ...
                            <div>
                                <ul>
                                    ...
                                    <li>Tự xây dựng được website từ API do Backend cung cấp hoặc API miễn phí</li>
